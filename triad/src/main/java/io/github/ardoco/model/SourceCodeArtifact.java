...
import io.github.ardoco.text.TextProcessor;
        ...
        switch (nodeType) {
            ...
            case "enum_declaration":
                ...
                if (classNameNode != null) {
                    updateFrequencies(bitermFrequencies, getTermsFromIdentifier(getNodeText(classNameNode, sourceCode)), 2);
                }
                break;
            ...
            case "method_declaration":
                ...
                if (methodNameNode != null) {
                    updateFrequencies(bitermFrequencies, getTermsFromIdentifier(getNodeText(methodNameNode, sourceCode)), 2);
                }
            ...
            case "method_invocation":
                ...
                if (methodInvocationNameNode != null) {
                    updateFrequencies(bitermFrequencies, getTermsFromIdentifier(getNodeText(methodInvocationNameNode, sourceCode)), 1);
                }
                break;
