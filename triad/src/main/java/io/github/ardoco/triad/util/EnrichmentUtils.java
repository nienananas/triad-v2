...
public final class EnrichmentUtils {
    ...
    // Defaults can be overridden via -D properties
    private static final double M_ENRICH = propDouble("triad.enrich.m", 0.02);
    private static final int TOP_K_ENRICH = propInt("triad.enrich.topk", 25);
    private static final int MAX_REP_PER_BITERM = propInt("triad.enrich.maxrep", 1999);
