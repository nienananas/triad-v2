...
class TextProcessorTest {
    ...
    void testProcessText_RE8() {
        ...
        String expectedProcessedText = "uav state transit request vehicl core transit uav state accord allow state transit depict uav state transit diagram";
    ...
    void testProcessText_DD537() {
        ...
        String expectedProcessedText = "mission plan synchron point flight plan uav synchron insert share synchron point order flight rout assign particip uav";
    ...
    void testProcessText_DD688() {
        ...
        String expectedProcessedText = "period updat uav locat ui period request current locat regist uav ui middlewar updat locat map";
