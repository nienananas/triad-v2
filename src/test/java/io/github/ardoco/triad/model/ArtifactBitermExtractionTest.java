...
class ArtifactBitermExtractionTest {
    ...
    void testBitermExtraction_FromProcessedCodeText() {
        String processedCodeText =
                "flight manag servic allow servic handl flight uav allow assign flight plan uav allow send flight relat command uav take return home singleton configur servic instanc";
